...
As has been shown, the states used here are still the polarization states
used in the previous subsection. To measure the
states Eve uses a duplicate of the
