...
The spacing between two consecutive extrema in the interference pattern is constant and can be determined by the measured path difference $\Delta L = \SI{17.3}{\centi\meter}$:
\begin{equation}
    \Delta \nu = \frac{c}{4\Delta L} = \frac{3 \times 10^8}{\num{4} \times \num{0.187}} \approx \SI{401}{\mega\hertz}
\end{equation}
